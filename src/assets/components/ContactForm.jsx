...
const ContactForm = () => {
  ...
  return (
    <motion.div
      className="max-w-[90vw] lg:w-[400px] mx-auto bg-gray-900/80 backdrop-blur-lg p-6 md:p-8 rounded-3xl shadow-2xl border border-gray-700 hover:shadow-3xl hover:bg-gray-800 transition-all duration-500 relative overflow-hidden group"
