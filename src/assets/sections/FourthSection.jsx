...
const FourthSection = () => {
  ...
  return (
    <motion.section
      ...
      className="w-full min-h-screen-ios h-120vh-ios max-md:h-[170vh] md:h-200vh-ios lg:h-105vh-ios xl:h-110vh-ios flex flex-col items-center justify-center max-md:justify-start max-md:pt-16 z-30 sticky top-0 mt-[9rem] md:mt-[15rem] lg:mt-[2rem] 2xl:mt-[20vh] overflow-hidden px-4 lg:px-8"
    >
      <AnimatedBackground2 />
      ...
      <div className="flex flex-col lg:flex-row z-50 relative max-md:bottom-0 md:bottom-4 lg:bottom-5 w-full max-w-[95vw] md:max-w-6xl px-2 lg:justify-center items-center lg:items-start xl:gap-100 md:gap-5">
        <div
