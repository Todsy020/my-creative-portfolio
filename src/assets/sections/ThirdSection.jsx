...
const ThirdSection = () => {
  ...
  return (
    <motion.section
      ...
      className="w-full h-screen-ios lg:h-110vh-ios flex items-center justify-center bg-slate-900 z-40 sticky top-0 mt-20 md:mt-32 lg:mt-36 overflow-hidden will-change-transform perspective-1000"
